...
function pootris (target, X, Y, string, timeout) {
    ...
    h += 'controls: left, right, space<br/>';
    h += 'goal: spell ' + string;
    h += '</div>';
    ...
    shortcut.add('Left',  piece.counterclockwise, {'type': 'keypress'});
    shortcut.add('Right', piece.clockwise, {'type': 'keypress'});
    shortcut.add('Space', piece.drop);
}
